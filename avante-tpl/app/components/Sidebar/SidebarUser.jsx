...
export default function SidebarUser({user, isAdmin, pioneer, href}) {
  return (
    <a href={href}>
      <div className={`p-2.5 mt-3 rounded-md px-4 duration-300 cursor-pointer text-white flex gap-4`}>
        ...
        <span className="text-[14px] text-gray-400 font-bold">{isAdmin ? "Admin" : ""}
        {pioneer ? `Pioneiro ${pioneer}` : "Publicador"}
        </span>
        </div>
